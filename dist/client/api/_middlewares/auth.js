...
const authenticate = (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const decoded = jsonwebtoken_1.default.verify(token, SECRET); // should return { userId: ... }
        ctx.state.user = decoded;
        yield next();
    }
    catch (err) {
        throw new exceptions_1.UnauthenticatedError({ message: "Invalid or expired token" });
    }
});
